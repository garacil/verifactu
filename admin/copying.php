...
print dol_get_fiche_head($head, 'copying', $langs->trans($page_name), 0, 'verifactu@verifactu');

// Get and process COPYING file content
$pathoffile = dol_buildpath("/verifactu/COPYING", 0);
...
if ((float) DOL_VERSION >= 6.0) {
    ...
    $content = dolMd2Html(
        ...
        'parsedown',
        array(
            'doc/' => dol_buildpath('verifactu/doc/', 1),
            'img/' => dol_buildpath('verifactu/img/', 1),
            'images/' => dol_buildpath('verifactu/images/', 1),
        )
    );
} else {
