 ...
 */
	...
	public function init($options = '')
	{
		...
		// Only the invoices of the entity being activated are initialized: in a
		// MultiCompany install the other entities may not even use VeriFactu.
